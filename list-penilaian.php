									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<select name="nilai[]" class="form-control" required>
												...
												?>
												<option value="<?= $d3['id_sub_kriteria'] ?>"><?= $d3['nama'] ?> : <?= $d3['nilai'] ?></option>
												<?php } ?>
											</select>
											<?php
											}else{
									...
									<div class="modal-body">
										...
										<div class="form-group">
											...
											<select name="nilai[]" class="form-control" required>
												...
												while($d3 = mysqli_fetch_array($q3)){
												?>
												<option value="<?= $d3['id_sub_kriteria'] ?>" <?php if($d3['id_sub_kriteria']==$d4['nilai']){echo "selected";} ?>><?= $d3['nama'] .' : Nilai ('.  $d3['nilai'] .')'?> </option>
												<?php } ?>
											</select>
											<?php
											}else{
