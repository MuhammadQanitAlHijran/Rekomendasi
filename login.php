    ...
    if (empty($errors)) :
        ...
        if ($cek > 0) {
            ...
            if ($data['password'] === $hashed_password) {
                ...
                $errors[] = 'Username atau password salah sekali!';
            }
        } else {
...
<body class="bg-gradient-purple">
    <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        <div class="container">
            <a class="navbar-brand" style="font-weight: 900; color: #304d8a;" href="login.php"> 
                <!-- <img src="assets/img/logo.png" class="mt-n2" width="70px">  -->
            Selamat Datang</a>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="row d-plex justify-content-between mt-5">
            <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                <!-- <img src="assets/img/logo.png" class="mt-5" width="500px"> -->
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="login.php" method="post">
                                        ...
                                        <button name="submit" type="submit" class="btn btn-user btn-block" style="background: #304d8a; color: #fff;"><i class="fas fa-fw fa-sign-in-alt mr-1"></i> Masuk</button>
                                    </form>
                                </div>
                            </div>
                        </div>
