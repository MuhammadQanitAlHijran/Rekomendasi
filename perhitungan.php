			...
			<div class="table-responsive">
				<table class="table table-bordered" width="100%" cellspacing="0">
					...
					<tbody>
						<?php
						$no = 1;
						// $query = mysqli_query($koneksi, "SELECT log_hasil From hasil ORDER BY log_hasil DESC LIMIT 1");
						// $log = mysqli_fetch_array($query);
						// // jika type data null jika data kosong
						// if($log === null){
						// 	$log_no= 1; 
						// }else{
						// 	$log_no= $log['log_hasil']+1;
						// }
						mysqli_query($koneksi, "TRUNCATE TABLE hasil;");
						foreach ($alternatif as $keys) : ?>
							<tr align="center">
								...
								<td>
									<?php
										echo $nilai_v;
										$qr = "INSERT INTO hasil (id_hasil, id_alternatif, nilai) VALUES ('', '$keys[id_alternatif]', '$nilai_v')";
